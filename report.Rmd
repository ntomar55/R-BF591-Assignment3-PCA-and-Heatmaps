...
caption_4 <- 'The bar chart represents individual variances of each principal component. The connected dots represent the cumulative variances'
caption_5 <- 'This is a plot of the true values of PC1 vs PC2. We have also classified the data points according to their subtypes.'
caption_8 <- 'This is a heatmap of the intesity values of the probes that are significant.'
```
